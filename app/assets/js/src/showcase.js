(function(window, document, undefined) {
	...
	teechioShowcase.factory('$acache', [ '$cacheFactory', function($cacheFactory) {
		return {
			get: function(key) {
	 ...
	 */
	teechioShowcase.directive('usersActivity', function($http) {
		return {
			restrict: 'EA',
			link: function(scope, element, attr) {
				...
				$http.get('/demo/analytics', { params: query })
	 ...
	 * @return {[type]}       [description]
	 */
	teechioShowcase.directive('topFiveCorrect', function($http) {
		return {
			restrict: 'EA',
			link: function(scope, element, attr) {
				var query = {
	 ...
	 * @return {[type]}       [description]
	 */
	teechioShowcase.directive('topFiveWrong', function($http) {
		return {
			restrict: 'EA',
			link: function(scope, element, attr) {
				var query = {
	 ...
	 * @return {[type]}       [description]
	 */
	teechioShowcase.directive('topFiveFastest', function($http) {
		return {
			restrict: 'EA',
			link: function(scope, element, attr) {
				var query = {
					...
					var chart = AmCharts.makeChart(
						element.attr('id'),
						{
							...
							valueAxes : [ {
								position : "left",
								title : "",
								maximum: _.findLast(refactoredData, function(item) { return item.avgActionDuration }),
								autoGridCount: false,
								gridCount: 20,
								labelsEnabled: false,
								gridAlpha: 0
	 ...
	 * @return {[type]}       [description]
	 */
	teechioShowcase.directive('usersHintsAvg', function($http) {
		return {
			restrict: 'EA',
			link: function(scope, element, attr) 
			{
	 ...
	 * @return {[type]}       [description]
	 */
	teechioShowcase.directive('usersList', function($http) {
		return {
			restrict: 'EA',
			link: function(scope, element, attr) {
				var query = {
	 ...
	 * @return {[type]}       [description]
	 */
	teechioShowcase.directive('answersDay', function($http) {
		return {
			restrict: 'EA',
			link: function(scope, element, attr) {
	 ...
	 * @return {[type]}       [description]
	 */
	teechioShowcase.directive('hintsCorrectSession', function($http) {
		return {
			restrict: 'EA',
			link: function(scope, element, attr) {
	 ...
	 * @return {[type]}       [description]
	 */
	teechioShowcase.directive('hintsWord', function($http) {
		return {
			restrict: 'EA',
			link: function(scope, element, attr) {
				var query = {
	 ...
	 * @return {[type]}       [description]
	 */
	teechioShowcase.directive('avgWidgets', function($http) {
		return {
			restrict: 'EA',
			link: function(scope, element, attr) {
